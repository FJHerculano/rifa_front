import "./modalEditaSorteio.css"

interface ModalEditaSorteioProps {
  isOpen: boolean;
  setClose: () => void;
}

const ModalEditaSorteio: React.FC<ModalEditaSorteioProps> = ({ isOpen, setClose }) => {
  return (
    <>
      {isOpen && (
...
export default ModalEditaSorteio;
